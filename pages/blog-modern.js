                            ...
                            <div className="col-lg-12">
                                <div className="grid_show_case grid_layout clearfix">
                                    ...
                                    <div className="news_box style_two grid_box _card  has_images">
                                        <div className="content_box">
                                            <div className="overlay"> </div>
                                            <img src="/assets/images/blog/blog-image-8.jpg" className="img-fluid" alt="img" />
                                            <div className="category">
                                                <Link href="#" className="categories"><i className="icon-folder" />HR Consulting</Link>
                                            </div>
                                            <div className="content_mid">
                                                <span className="date_in_number">October 8, {new Date().getFullYear()}</span>
                                                <h2 className="title"><Link href="/" >Most Employees Support
                                                    Measures</Link></h2>
                                            </div>
                                            <div className="auhtour_box">
                                                <img alt="img" src="/assets/images/auth-1.png" height={60} width={60} className="img-fluid" />
                                    ...
                                    <div className="news_box style_two grid_box _card  has_images">
                                        <div className="content_box">
                                            ...
                                            <div className="content_mid">
                                                <span className="date_in_number">October 8, {new Date().getFullYear()}</span>
                                                <h2 className="title"><Link href="/" >Retaining Good Employees
                                                    &amp;
                                                    Motivated</Link></h2>
                                            </div>
                                            <div className="auhtour_box">
                                    ...
                                    <div className="news_box style_two grid_box _card  has_images">
                                        <div className="content_box">
                                            <div className="overlay"> </div>
                                            <img src="/assets/images/blog/blog-image-5.jpg" className="img-fluid" alt="img" />
                                            <div className="category">
                                                <Link href="#" className="categories"><i className="icon-folder" />Compliance Audits</Link>
                                            </div>
                                            <div className="content_mid">
                                                <span className="date_in_number">October 8, {new Date().getFullYear()}</span>
                                                <h2 className="title"><Link href="/" >Understanding Executive
                                                    Coaching</Link></h2>
                                            </div>
                                            <div className="auhtour_box">
                                                <img alt="img" src="/assets/images/auth-1.png" height={60} width={60} className="img-fluid" />
                                    ...
                                    <div className="news_box style_two grid_box _card  has_images">
                                        <div className="content_box">
                                            ...
                                            <div className="content_mid">
                                                <span className="date_in_number">October 8, {new Date().getFullYear()}</span>
                                                <h2 className="title"><Link href="/" >How to Handle Your Good
                                                    Employee</Link></h2>
                                            </div>
                                            <div className="auhtour_box">
                                                <img alt="img" src="/assets/images/auth-2.png" height={60} width={60} className="img-fluid" />
                                    ...
                                    <div className="news_box style_two grid_box _card  has_images">
                                        <div className="content_box">
                                            <div className="overlay"> </div>
                                            <img src="/assets/images/blog/blog-image-3.jpg" className="img-fluid" alt="img" />
                                            <div className="category">
