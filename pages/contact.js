...
export default function Contact() {
  return (
    <>
      <Layout breadcrumbTitle="Contact" headerStyle={4} footerStyle={4}>
        <div>
                  ...
                  <div className="contact_box_content style_one">
                    <div className="contact_box_inner icon_yes">
                      ...
                      <div className="contnet">
                        <h3> Post Address </h3>
                        <p>
                          #602, Challa Mall, Sir Thygaraya Road, T.nagar,chennai
                          600017, Tamil Nadu.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="contact_box_content style_one">
                    <div className="contact_box_inner icon_yes">
                      ...
                      <div className="contnet">
                        ...
                        <p>
                          <b>Email:</b> customercare@j2wealth.co.in
                          <br />
                          digital@j2wealth.co.in <br />
                          <b>Customer Care Number:</b> - 9500002366
                          <br />
                          <b>Dealer’s Desk:</b> - 9150033051 | 9150033049
                          <br />
                          <b>Tax Advisor Number:</b> - 9150033053
                          <br />
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-lg-12">
                  <section className="map-section">
                    ...
                    <div className="map-outer">
                      <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7773.872400266167!2d80.242815!3d13.039733!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5266521207ac8d%3A0x6ad5b3af06e59009!2sChalla%20Mall!5e0!3m2!1sen!2sus!4v1754656762436!5m2!1sen!2sus"
                        height={570}
                        style={{ border: 0 }}
                        allowFullScreen
                        loading="lazy"
